...
public class DriveSubsystem extends SubsystemBase implements ITelemetryProvider {
     ...
     * Drive Constants
     */
    private static final double kS = 0.0645; // Volts
    private static final double kV = 2.84; // VoltSeconds Per Meter
    private static final double kA = 0.28; // VoltSecondsSquared Per Meter
    private static final double kP = 2.53; // Drive Velocity
